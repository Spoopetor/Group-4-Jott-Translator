...
public class ElseifNode implements JottTree {
    ...
    public ElseifNode(ExprNode e, BodyNode b) {
        this.e = e;
        this.b = b;
    }
    @Override
    public String convertToJott() {
        return "elseif[" + this.e.convertToJott() + "]{" + this.b.convertToJott() + "}";
    }
    ...
    static public ElseifNode parseElseifNode(ArrayList<Token> tokens) {
        ...
        if (tokens.get(0).getTokenType() == TokenType.ID_KEYWORD && tokens.get(0).getToken().equalsIgnoreCase("elseif")) {
            ...
            expNode = parseExprNode(tokens.remove(0));
            ...
            return new ElseifNode(expNode, bodyNode);
